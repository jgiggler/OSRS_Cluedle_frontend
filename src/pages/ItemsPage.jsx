...
function ItemsPage() {
    ...
    const fetchImage = async () => {
      const res = await fetch('https://cors-everywhere.heroukuapp.com/http://13.57.219.246:8080/item');
    ...
    async function handleSubmit(e) {
      ...
      const data = await fetch('https://cors-everywhere.heroukuapp.com/http://13.57.219.246:8080/guesscheck', {method: 'POST',
