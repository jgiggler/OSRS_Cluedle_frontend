...
function ItemsPage() {
    ...
    const fetchImage = async () => {
      const res = await fetch('ec2-13-57-219-246.us-west-1.compute.amazonaws.com/item');
    ...
    async function handleSubmit(e) {
      ...
      const data = await fetch('ec2-13-57-219-246.us-west-1.compute.amazonaws.com/guesscheck', {method: 'POST',
